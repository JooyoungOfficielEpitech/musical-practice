...
export function ScoreSettingsSheet({
...
}: ScoreSettingsSheetProps): React.JSX.Element {
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onDismiss} accessibilityViewIsModal>
      ...
      <SafeAreaView testID="score-settings-sheet" style={[styles.sheet, { backgroundColor: colors.surface }]} edges={["bottom"]}>
        <View style={styles.header}>
          ...
          <Pressable onPress={onDismiss} accessibilityLabel="Close settings" accessibilityRole="button" hitSlop={8} style={styles.closeBtn}>
...
const styles = StyleSheet.create({
  ...
  closeBtn: { position: "absolute", right: 0, top: Spacing.sm, width: 44, height: 44, alignItems: "center", justifyContent: "center" },
  row: {
    flexDirection: "row",
    alignItems: "center",
    gap: Spacing.sm,
